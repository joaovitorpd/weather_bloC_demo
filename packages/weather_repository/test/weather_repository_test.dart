...
///Just as with the data layer, it's critical to test the repository layer in
///order to make sure the domain level logic is correct. To test our
///WeatherRepository, we will use the mocktail library. We will mock the underlying
///api client in order to unit test the WeatherRepository logic in an isolated,
...
void main() {
  group('WeatherRepository', () {
    ...
    group('constructor', () {
      test('instances internal MetaWeatherApiClient when not injected', () {
